<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DistrictLogin.aspx.cs" Inherits="DistrictLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main>
        <div class="form">
            ...
            <div class="login-box">
                <div class="">
                    <asp:DropDownList runat="server" ID="ddldistrict" CssClass="select" AutoCompleteType="Disabled"></asp:DropDownList>
    ...
    <script language="javascript" type="text/javascript">
        function SHA512auth() {
            ...
            var UName = document.getElementById("<%=ddldistrict.ClientID%>").value;
            if (UName == "") {
