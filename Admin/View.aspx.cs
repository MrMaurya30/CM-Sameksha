...
public partial class Admin_View : System.Web.UI.Page
{
    ...
    {
        //if (Session["RowId"] == null || Session["RoleID"] == null)
        //{
        //    Session.Clear();
        //    Session.Abandon();
    ...
    protected void bindText()
    {
        try
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                //  lblcreatedate.Text = FormatDate(dt.Rows[0]["Date1"].ToString());
                ...
                // Project Details with Read More/Read Less support
    ...
    protected void btnresponse_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Hidden field (child ke liye parent ID)
            ...
            HiddenField btnhiden = (HiddenField)row.FindControl("btnhiden");
            string ff = btnhiden.Value;
    ...
    protected void btnIssue_Click(object sender, EventArgs e)
    {
        ...
        {
            int RoleID = Convert.ToInt32(Session["RoleID"]);
            int issueId = Convert.ToInt32(Session["RowId"]);
            ...
            //    }
            //}
            DB.SaveReply(issueId, RoleID, null, ViewState["UserIP"].ToString(), txtissue.Text, null, Session["EmployeeName"].ToString());
            txtissue.Text = "";
            BindGrid();
            Response.Redirect(Request.RawUrl);
        }
    ...
    protected void tbnissuimg_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (fileUpload3.HasFile)
            {
                ...
                // Optional: validate file type
                string[] allowedExt = { ".jpg", ".jpeg", ".png", ".gif" ,".pdf",".xls","xlsm"};
                if (allowedExt.Contains(extension.ToLower()))
                {
                    string fileName = Guid.NewGuid().ToString() + extension;
