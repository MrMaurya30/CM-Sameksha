<%@ Page Title="" Language="C#" MasterPageFile="~/Districts/MasterDist.master" AutoEventWireup="true" CodeFile="DistrictsList.aspx.cs" Inherits="Districts_DistrictsList" %>
    ...
    <div class="section">
        ...
        <asp:GridView 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Disctict">
