...
public partial class Districts_View : System.Web.UI.Page
{
    ...
    //    // DB.SaveReply(issueId, RoleID, null, ViewState["UserIP"].ToString(), txtissue.Text, null, Session["DeptName"].ToString());
    ...
    protected void btnback_Click(object sender, EventArgs e)
    {
        ...
        {
            //     Session.Clear();
            Response.Redirect("Districts/DistrictsList.aspx");
