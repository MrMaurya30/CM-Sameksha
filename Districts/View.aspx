<%@ Page Title="" Language="C#" MasterPageFile="~/Districts/MasterDist.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Districts_View" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="section">
        ...
        <div class="section subsection">
            <div class="project-info project-info-flag" style="margin-bottom:20px;">
            <p><strong>Project ID:</strong><asp:Label ID="lblProjectID" runat="server"></asp:Label></p>
            <p><strong>Date:</strong><asp:Label ID="lblProjectDate" runat="server"></asp:Label></p>
             </div>
            <div class="view-details">
                
                 <p><strong>Project Name: </strong>
                    <asp:Label ID="lblProjectName" runat="server"></asp:Label></p>
                <p><strong>Meeting Date: </strong>
                    <asp:Label ID="lblMeetingDate" runat="server"></asp:Label></p>
                <p><strong>Letter Date: </strong>
                    <asp:Label ID="lblLetterDate" runat="server"></asp:Label></p>
                <p><strong>Letter No: </strong>
                    <asp:Label ID="lblLetterNo" runat="server"></asp:Label></p>
                <p><strong>Officer: </strong>
                    <asp:Label ID="lblOfficer" runat="server"></asp:Label></p>
                <p><strong>Location: </strong>
                    <asp:Label ID="lblLocation" runat="server"></asp:Label></p>
                <p><strong>Approved Date: </strong>
                    <asp:Label ID="lblApprovedDate" runat="server"></asp:Label></p>
                <p><strong>Project Cost: </strong>
                    <asp:Label ID="lblProjectCost" runat="server"></asp:Label></p>
                <p><strong>Revised Cost: </strong>
                    <asp:Label ID="lblRevisedCost" runat="server"></asp:Label></p>
                <p><strong>Scheduled Completion: </strong>
                    <asp:Label ID="lblScheduledCompletion" runat="server"></asp:Label></p>
                <p><strong>Anticipated Completion: </strong>
                    <asp:Label ID="lblAnticipatedCompletion" runat="server"></asp:Label></p>
                <p><strong>Physical Progress: </strong>
                    <asp:Label ID="lblPhysicalProgress" runat="server"></asp:Label></p>
                <p><strong>Financial Progress: </strong>
                    <asp:Label ID="lblFinancialProgress" runat="server"></asp:Label></p>
                <p><strong>Division: </strong>
                    <asp:Label ID="lblDivision" runat="server"></asp:Label></p>
        ...
        <div class="issues-section mt-20" id="pnlIssuesSection" runat="server">
                                                ...
                                                <div class="response-info">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        onclick="toggleReplyWithParent(this,
                                                            ...
                                                            '<%# Eval("ID") %>');"
                                                        class="button" style="margin-left: 5px">Reply
                                                    </a>
                                                </div>
                                            </td>
                                ...
                                <asp:Panel ID="pnlReply" runat="server" Style="display: none;">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Button ID="btnresponse"
                                            runat="server"
                                            Text="Reply"
                                            CssClass="button reply-btn"
                                            Style="margin: 5px 0"
                                            OnClick="btnresponse_Click" CommandArgument='<%#Eval("ID") %>' />
                                    </div>
                                </asp:Panel>
                                <a class="button reply-btn response-btn align-center"
