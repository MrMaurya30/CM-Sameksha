...
public partial class Districts_Changepass : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataTable dt = DB.changpassDisct(txtPassword.Text.ToString(), txtconfirmpasss.Text.ToString(), dept);
                if (dt.Rows.Count > 0)
                {
