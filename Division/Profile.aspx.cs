...
public partial class Division_Profile : System.Web.UI.Page
{
    ...
    protected void binddivisionprofile()
    {
        try
        {
            string UserName = Session["Username"].ToString();

            DataTable dt = DB.BindDivisionProfile(UserName);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string UserName = Session["Username"].ToString();
            DataTable dt = DB.UpdateDivisionProfile(txtname.Text.Trim(), txtmobile.Text.Trim(), txtemail.Text.Trim(), UserName);
