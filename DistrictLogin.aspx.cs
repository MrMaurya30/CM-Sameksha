...
public partial class DistrictLogin : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = DB.LoginDistrict(ddldistrict.SelectedValue.ToString(), txtPassword.Text.Trim(), ip);
            ...
            String DeptName = ddldistrict.SelectedItem.Text.ToString();// dt.Rows[0]["DeptName"].ToString();
            ...
            if (usertype == "Districts")
            {
                ...
                Response.Redirect("Districts/DistrictsList.aspx", false);
