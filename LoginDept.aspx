<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoginDept.aspx.cs" Inherits="LoginDept" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        <div class="form">
            ...
            <div class="login-box">
                <div class="">  
                    <asp:DropDownList runat="server" ID="ddldeparment"  CssClass="select" ></asp:DropDownList>
                    <%--<asp:TextBox 
                        ID="txtUsername" 
            ...
            <div class="captcha-container">
                ...
                <div class="">
                    <asp:TextBox ID="txtCaptcha" runat="server"
                        CssClass="enter-captcha"  AutoCompleteType="Disabled"
        ...
        function SHA512auth() {
            try {
               ...
               // var randomnumber = '<%=Session["Rand"]%>';
                var UName = document.getElementById("<%=ddldeparment.ClientID %>").value;  
                if (UName == "") {
