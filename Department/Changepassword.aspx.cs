...
public partial class Department_Changepassword : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtnewpass.Text == txtconfirmpasss.Text)
            {
                ...
                DataTable dt = DB.changpassDEPT(txtPassword.Text.ToString(), txtconfirmpasss.Text.ToString(), deptid);
                if (dt.Rows.Count > 0)
                {
