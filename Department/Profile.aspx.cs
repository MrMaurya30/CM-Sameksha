...
public partial class Department_Profile : System.Web.UI.Page
{
    ...
    protected void bindtprofile()
    {
        try
        {
            string deptid = Session["UserName"].ToString();
            DataTable dt = DB.BindDeptFprofile(deptid);
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string deptid = Session["UserName"].ToString();
            DataTable dt = DB.Logindeptprofil(txtname.Text.ToString(), txtmobile.Text.ToString(), txtemail.Text.ToString(), deptid);
