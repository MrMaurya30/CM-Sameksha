...
public partial class Department_DepartmentView : System.Web.UI.Page
{
    ...
    protected void BindDeptView()
    {
        try
        {
            string UserID = Session["Username"].ToString();
            DataTable dt = Db.BindDeptView(UserID);
            if (dt != null)
            {
                gvLetters.DataSource = dt;
                gvLetters.DataBind();
            }
            else
            {
                gvLetters.DataSource = null;
                gvLetters.DataBind();
            }
        }
        catch (Exception ex)
    ...
    protected void gvLetters_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "View")
            {
                ...
                Response.Redirect("/Department/View.aspx");
            }
        }
        catch (Exception ex)
        { }
