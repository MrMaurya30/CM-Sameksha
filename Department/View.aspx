<%@ Page Title="" Language="C#" MasterPageFile="~/Department/MasterDept.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Department_View" %>
...
<%--            <p class="project-info">
                Project Date: <asp:Label runat="server" ID="lblcreatedate"></asp:Label>
            </p>--%>
        </div>
